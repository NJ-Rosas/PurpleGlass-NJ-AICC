...
namespace PurpleGlass.Modules.CallManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260802032030_AddCallStartingLanguage")]
    partial class AddCallStartingLanguage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PurpleGlass.Modules.CallManagement.Domain.CallSession", b =>
                {
                    ...
                    b.Property<string>("ProviderParentCallId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("StartingLanguageCode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(35)
                    ...
                    b.Property<string>("StartingLanguageReason")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("PurpleGlass.Modules.CallManagement.Domain.TelephonyNumber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProviderNumberId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("Provider", "NormalizedNumber")
                        .IsUnique();
                    ...
                    b.ToTable("telephony_numbers", "call_management");
                });

            modelBuilder.Entity("PurpleGlass.Modules.CallManagement.Domain.TelephonyOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CallId", "Type")
                        .IsUnique();

                    b.ToTable("telephony_operations", "call_management");
                });
            ...
            modelBuilder.Entity("PurpleGlass.Modules.CallManagement.Infrastructure.TelephonyWebhookReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("telephony_webhook_receipts", "call_management");
                });
