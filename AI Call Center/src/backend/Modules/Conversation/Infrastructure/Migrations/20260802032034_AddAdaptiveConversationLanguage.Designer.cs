...
namespace PurpleGlass.Modules.Conversation.Infrastructure.Migrations
{
    ...
    [Migration("20260802032034_AddAdaptiveConversationLanguage")]
    partial class AddAdaptiveConversationLanguage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PurpleGlass.Modules.Conversation.Domain.Conversation", b =>
                {
                    ...
                    b.Property<long>("LanguageChangeSequence")
                        .HasColumnType("bigint");

                    b.Property<DateTimeOffset>("LanguageChangedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal?>("LanguageDetectionConfidence")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)");

                    b.Property<string>("LanguageReason")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.Property<string>("StartingLanguage")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(35)
                        .HasColumnType("character varying(35)")
            ...
            modelBuilder.Entity("PurpleGlass.Modules.Conversation.Domain.ConversationLanguageChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PreviousLanguageCode")
                        .IsRequired()
                        .HasMaxLength(35)
                        .HasColumnType("character varying(35)");
                    ...
                    b.ToTable("conversation_language_changes", "conversation");
                });
