...
4. The standard G.711 μ-law encoder converts every valid 8 kHz sample. As soon as the explicit 100 ms startup reserve is available, PurpleGlass sends five ordered 20 ms/160-byte packets and begins the monotonic packet schedule; bounded send-ahead remains approximately 100 ms.
